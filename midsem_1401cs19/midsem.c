...
/*	SYSTEM PROGRAMMING 
	Name - Jitendra Kumar
	roll - 1401cs19
	Sub  - midsemester examination CS242
	date - 16/02/16
*/
...
int main(int argc , char **argv)
{
	...
	printf("\n");
	printf("\n*****************************************************************************************************\n");
	printf("\t\t\t\t\t !  Welcome to pc information wizard  !\n");
	...
	return 0 ;
			...
			/* function for printing the CPU information */
void printCPUinfo()
{
	printf("\n");
	FILE *cpuinfo = fopen("/proc/cpuinfo","rb");			// opening /proc/cpuinfo to read the cpu details binary mode 
	char line[1024];						// defining buffer 
	int count = 0 ;
	...
	printf("\n");
			...
			/* function for printing the linux kernal version */
void LinuxKernalVersion()
{
	...
	printf("\n");
			...
			/* function for printing the time when system was booted last time in given format */
void boottime()	
{
	...
	printf("\n");
			...
			/* function for printing the number of interrupts handled so far */
void interrupts()
{
	...
	printf("\n");
			...
			/* function for printing the total swap memory and the partition sizes */
void swapMemory()
{
	...
	printf("\n");
			...
			/* function for printing the time cpu spent in user mode and kernal mode */
void cpuTime()
{
	...
	printf("\n");
			...
			/* function for  total free memory and usable memory */
void freeMemory()
{
	...
	printf("\n");
 			...
 			/* function for  total number of context switches made by system so for */
void ctxtSwitches()
{
	...
	printf("\n");
			...
			/* function for average load on system in last 15 minutes */
void averageLoad()
{
